   	...
   	stage('SonarQube Analysis'){
			...
			/*    timeout(time: 1, unit: 'HOURS') { 
              		...
              		//	}
						...
						response = sh(script: "curl -s http://104.248.169.167:9000/api/qualitygates/project_status?projectKey=com.mycompany:location-system-api", returnStdout: true).trim()
						echo response
